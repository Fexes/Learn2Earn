package com.quickblox.sample.groupchatwebrtc.groupchannel;
...
import com.quickblox.sample.groupchatwebrtc.utils.DateUtils;
import com.quickblox.sample.groupchatwebrtc.utils.FileUtils;
import com.quickblox.sample.groupchatwebrtc.utils.ImageUtils;
import com.quickblox.sample.groupchatwebrtc.utils.TextUtils;
import com.quickblox.sample.groupchatwebrtc.utils.UrlPreviewInfo;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_USER_MESSAGE_ME:
                if (GroupChannelActivity.file.equals("yes")) {
                    View myUserMsgView = LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.list_item_group_chat_user_me_gone, parent, false);
            ...
            case VIEW_TYPE_USER_MESSAGE_OTHER:
                if (GroupChannelActivity.file.equals("yes")) {
                    View otherUserMsgView = LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.list_item_group_chat_user_other_gone, parent, false);
