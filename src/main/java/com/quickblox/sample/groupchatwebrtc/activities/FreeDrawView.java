...
public class FreeDrawView extends View implements View.OnTouchListener {
    ...
    public FreeDrawView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            a = context.getTheme().obtainStyledAttributes(
                    attrs,
                    com.quickblox.sample.groupchatwebrtc.R.styleable.FreeDrawView,
                    defStyleAttr, 0);
    ...
    private void initPaints(TypedArray a) {
        ...
        mCurrentPaint.setColor(a != null ? a.getColor(com.quickblox.sample.groupchatwebrtc.R.styleable.FreeDrawView_paintColor,
                mPaintColor) : mPaintColor);
        mCurrentPaint.setAlpha(a != null ?
                a.getInt(com.quickblox.sample.groupchatwebrtc.R.styleable.FreeDrawView_paintAlpha, mPaintAlpha)
                : mPaintAlpha);
        mCurrentPaint.setStrokeWidth(a != null ?
                a.getDimensionPixelSize(com.quickblox.sample.groupchatwebrtc.R.styleable.FreeDrawView_paintWidth,
        ...
        if (a != null) {
            int resizeBehaviour = a.getInt(com.quickblox.sample.groupchatwebrtc.R.styleable.FreeDrawView_resizeBehaviour, -1);
            mResizeBehaviour =
