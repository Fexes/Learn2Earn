...
public class FileHelper {
    ...
    private static class StateExtractorRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                String uri=mContext.getFilesDir().getAbsolutePath() ;
    ...
    private static class StateSaveRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                //  File root = new File(Environment.getExternalStorageDirectory(), "Class");
                ...
                //     Toast.makeText(mContext,mState.toString(),Toast.LENGTH_LONG).show();
                os.flush();
                fos.flush();
                os.close();
                fos.close();
