...
public class Const {
    ...
    static final String SCREEN_RECORDING_START = "com.quickblox.sample.groupchatwebrtc.services.action.startrecording";
    static final String SCREEN_RECORDING_PAUSE = "com.quickblox.sample.groupchatwebrtc.services.action.pauserecording";
    static final String SCREEN_RECORDING_RESUME = "com.quickblox.sample.groupchatwebrtc.services.action.resumerecording";
    static final String SCREEN_RECORDING_STOP = "com.quickblox.sample.groupchatwebrtc.services.action.stoprecording";
