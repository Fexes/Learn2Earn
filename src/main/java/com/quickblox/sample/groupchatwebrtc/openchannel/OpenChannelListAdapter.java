    ...
    void setOpenChannelList(List<OpenChannel> channelList) {
        ...
        try {
            for(int i = 0; i <= channelList.size(); i++) {
                ...
                if (!channelList.get(i).getName().contains(preferences.getString("recommendation", null))) {
        ...
        try {
            for(int i = 0; i <= mChannelList.size(); i++) {
                ...
                if (!mChannelList.get(i).getName().contains(preferences.getString("recommendation", null))) {
