...
import com.quickblox.sample.groupchatwebrtc.folderpicker.FolderChooser;
import com.quickblox.sample.groupchatwebrtc.folderpicker.OnDirectorySelectedListerner;
...
public class SettingsPreferenceFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener
    ...
    //Set permissionListener in Record
    private void setPermissionListener() {
        if (getActivity() != null && getActivity() instanceof Record) {
    ...
    public void onDirectorySelected() {
        ...
        if (getActivity() != null && getActivity() instanceof Record) {
            ((Record) getActivity()).onDirectoryChanged();
        }
    }
